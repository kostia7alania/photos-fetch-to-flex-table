<template>
    <div>      
                <div class="row_head" :class="{oddk:ind%2, evenk:!(ind%2)}" @click="showModal =! showModal">
                  ...
                  <div class="grow2"> {{insp.InspDateOfInspect}} </div>
                  <div class="grow2"> {{insp.InspDateOfSubmit}} </div>
                  <div class="grow2" :title="insp.Render_Place_Title"> {{insp.Render_Place}}</div>
                  <div class="grow2"> {{insp.ShipIMO}}</div>
                  <div class="grow3"> {{insp.ShipName}}</div>
                  <div class="grow2"> {{insp.ShipCallsign}}</div>
                  <div class="grow2"> {{insp.ShipMMSI}}</div>
                  <div class="grow2" :title="insp.ShipFlagCode_Render_Title"> {{insp.ShipFlagCode_Render}}</div>
                  <div class="grow2"> {{insp.InspDeficiencies}}</div>
                  <div class="grow2"> {{insp.InspDetention>0?"yes":'no'}} </div>
                </div> 
